...
namespace SyshiBarListImplement.Implements
{
    ...
    List<StorageSeafoodViewModel>();
        ...
        public bool CheckFoodsAvailability(int SushiId, int SushisCount)
        {
            ...
            {
                int count = 0;
                count = source.StorageSeafoods.FindAll(x => x.SeafoodId == elem.SeafoodId).Sum(x => x.Count);
        ...
        public void RemoveFromStorage(int SushiId, int SushisCount)
        {
            ...
            foreach (var elem in SushiSeafoods)
            {
                ...
                var storageSeafoods = source.SushiSeafoods.FindAll(x => x.SeafoodId == elem.SeafoodId);
