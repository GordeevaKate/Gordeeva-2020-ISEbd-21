...
namespace SyshiBarView
{
    public partial class FormFillStorage : Form
    {
        ...
        private readonly ISeafoodLogic logicSF;
        private readonly MainLogic logicM;
        private readonly IStorageLogic logicS;
        public FormFillStorage(ISeafoodLogic logicSF, MainLogic logicM, IStorageLogic logicS)
        {
            InitializeComponent();
            this.logicSF = logicSF;
            this.logicM = logicM;
            this.logicS = logicS;
        }
        private void FormFillStorage_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                var SeafoodList = logicSF.Read(null);
